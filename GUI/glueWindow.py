...
class GlueWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("GlueWindow")
        ...
        self.title = QLabel("Gluing Settings")
        ...
        self.forwordButton.setFixedSize(100, 50)
        ...
        self.backwordButton.setFixedSize(100, 50)
        ...
        self.glueButton.setFixedSize(100,50)
